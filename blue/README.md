...
* `Playbooks` - Checklists for hardening services, OSs, and configuring our infrastructure during competition.
* `Services` - Theory and explanations for managing and hardening common services.
* `Systems` - Theory and explanations for managing and hardening Operating Systems
* `Tools` - Scripts used in competition
...
Put general notes about the topic here, explaining it.

### :red_circle: Red team :red_circle:

Explain how that topic can be exploited here.

### :large_blue_circle: Blue team :large_blue_circle:

Explain the steps that should be taken to mitigate/patch the exploit here.
